...
// Apply will set the field format value transform for ref.
func (t Transform) Apply(ref *Options) {
	ref.Transform = t
}

// Options returns a set of field format options with the transform.
func (t Transform) Options() (opts Options) {
	t.Apply(&opts)
	return
}
